...
// This goes through the test list and calls the execute method for each test.
/*void TestHarness::run_tests()
{
	std::cout << "run_tests called" << endl;
...
// This is the method which calls each test to be tested in the try block. 
